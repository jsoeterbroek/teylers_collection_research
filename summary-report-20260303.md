...
An AI-assisted analysis of **35 randomly selected objects** from Teylers Museum's online catalog (<https://teylers.adlibhosting.com>) has identified **60 major errors** and over **150 minor omissions**. No single object was found to be free of errors or significant omissions.
...
The AI-assisted methodology demonstrated here is **scalable to the entire collection** at a fraction of the cost of traditional art-historical review. A systematic scan would dramatically improve the quality and accessibility of Teylers' online catalog — and the public understanding of one of the world's most important heritage collections.
...
| Fossils | 2 | 4 | 2.0 |
| Sculpture | 1 | 1 | 1.0 |
| **Total** | **35** (1 object counted in instruments+sculpture) | **60** (adjusted) | **1.7** |
...
| Total tokens processed | ~3,500,000 |
| Research agent invocations | ~45 |
| Web fetches | ~60 |
| Estimated compute cost | ~€120–€150 |
| Total analysis time | ~3 sessions, ~12 hours |

The cost of analyzing 35 objects with AI assistance (~€130) compares favorably with the cost of equivalent manual art-historical research, which would require days of specialist time per object. **Scaled to a full collection scan, this methodology could review thousands of objects for a fraction of traditional costs.**
...
2. **Add description fields** to all objects, especially scientific instruments and coins/medals
3. **Implement cross-references** between related objects (series, suites, provenance groups)
4. **Contextualize all persons** with brief biographical notes
5. **Translate all inscriptions** into Dutch and English
6. **Update geological dates** for fossils to reflect current scientific knowledge
7. **Cite standard reference catalogs** (Turner & Levere, Van Loon, Hollstein, etc.)
8. **Link to external digital surrogates** where available (EEBO, BHL, Rijksmuseum, etc.)
9. **Review the "Cornelius Stanhope" attribution** (object 1020) against the physical title page
10. **Verify Van Bylaer's birth date** — the catalog gives "±1540" across multiple objects, but sources indicate c. 1553
...
The analysis of 35 randomly selected objects from across Teylers Museum's collections reveals a **consistent pattern of quality problems** in the online catalog. With 60 major errors across 35 objects and not a single error-free record, the evidence strongly suggests that these problems are systemic.
...
Teylers Museum holds one of the most important heritage collections in the world. Its online catalog should reflect that distinction. The findings in this report are offered as a constructive contribution toward that goal.

---

*This report was produced using AI-assisted research (Claude Opus 4.6, Anthropic). All findings are based on publicly available sources and cross-references with other museum collections. Individual analysis reports for all 35 objects are available at <https://github.com/jsoeterbroek/teylers_collection_research>.*
