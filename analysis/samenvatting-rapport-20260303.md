...
De hier gedemonstreerde AI-methodiek is **schaalbaar naar de gehele collectie** tegen een fractie van de kosten van traditioneel kunsthistorisch onderzoek. Een systematische scan zou de kwaliteit en toegankelijkheid van Teylers' online catalogus dramatisch verbeteren — en het publieke begrip van een van 's werelds belangrijkste erfgoedcollecties.
...
10. **407 — De oprichtingscatalogus van Rijksmuseum Boerhaave is niet geïdentificeerd.** Dit bescheiden boekje van 70 pagina's leidde direct tot de oprichting van het nationale wetenschapsmuseum. De auteur, Crommelin, speelde kamermuziek met Einstein.
...
2. **Beschrijvingsvelden toevoegen** aan alle objecten, met name wetenschappelijke instrumenten en munten/penningen
3. **Kruisverwijzingen implementeren** tussen verwante objecten (series, suites, herkomstgroepen)
4. **Alle personen contextualiseren** met korte biografische notities
5. **Alle inscripties vertalen** in het Nederlands en Engels
6. **Geologische dateringen bijwerken** voor fossielen naar de huidige wetenschappelijke kennis
7. **Standaard referentiecatalogi citeren** (Turner & Levere, Van Loon, Hollstein, etc.)
8. **Linken naar externe digitale surrogaten** waar beschikbaar (EEBO, BHL, Rijksmuseum, etc.)
9. **De "Cornelius Stanhope"-toeschrijving herzien** (object 1020) aan de hand van de fysieke titelpagina
10. **Van Bylaers geboortedatum verifiëren** — de catalogus geeft "±1540" bij meerdere objecten, maar bronnen wijzen op c. 1553
...
| KG 04733 | Serie niet geïdentificeerd | niet vermeld | Titelpagina "Dieren"-serie (8 platen) |
...
| TMNK 00009 | Serie niet geïdentificeerd | niet vermeld | "Judenmedaille" — Praagse serie, c. 1600–1650 |
...
| 2163 | Auteur niet geïdentificeerd | "G. Cuvier" | Baron Georges Cuvier, oprichter vergelijkende anatomie; bezocht Teylers 1811 |
...
| FK 1980 01 | Van der Bildt-dynastie niet geïdentificeerd | "J. v.d. Bildt, Franeker" | 550+ telescopen; conservator Franeker Universiteit |
...
| TMNK 00272 | Munttype niet geïdentificeerd | "gehelmde rijksdaalder" | Moet identificeren als "prinsendaalder" — standaard numismatische naam |
...
| 1020 | Gataker niet geïdentificeerd | niet vermeld | Thomas Gataker (1574–1654); zijn editie is "the principal authority" over de *Meditaties* |
...
De analyse van 35 willekeurig geselecteerde objecten uit de collecties van Teylers Museum onthult een **consistent patroon van kwaliteitsproblemen** in de online catalogus. Met 60 ernstige fouten over 35 objecten en geen enkel foutvrij record wijst het bewijs sterk op systemische problemen.
...
Teylers Museum beheert een van de belangrijkste erfgoedcollecties ter wereld. De online catalogus zou die status moeten weerspiegelen. De bevindingen in dit rapport worden aangeboden als een constructieve bijdrage aan dat doel.

---

*Dit rapport is tot stand gekomen met behulp van AI-onderzoek (Claude Opus 4.6, Anthropic). Alle bevindingen zijn gebaseerd op publiek beschikbare bronnen en kruisverwijzingen met andere museale collecties. Individuele analyserapporten voor alle 35 objecten zijn beschikbaar op <https://github.com/jsoeterbroek/teylers_collection_research>.*
